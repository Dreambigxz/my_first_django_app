...
# SESSION_ENGINE = 'users.session_backend'
...
INSTALLED_APPS = [
    ...
    'djanfail_silently=Falsego.contrib.messages',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ecommerce.context_processors.base',
                'userwallet.context_processors.user_wallet',
                'userwallet.context_processors.ref_deposit',
